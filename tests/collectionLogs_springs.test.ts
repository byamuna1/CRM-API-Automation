...
import { apiRequestReceiptLogs, createFolder } from '../generic/apiRequest_springs';
...
test ("springs ReceiptLogs Details" , async () => {
    ...
    for(let i = 6;i<10000;i++)
    {
        ...
        if((receiptDetails.milestone != 'Lumpsum' && receiptDetails.receiptNo != null && receiptDetails.amount != null) || (receiptDetails.milestone == 'Lumpsum' && receiptDetails.receiptNo != null))
        {
