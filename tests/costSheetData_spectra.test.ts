...
test ("spectra costsheet Data" , async () => {
    ...
    for(let index=0; index<res.data.length ; index++)
    {
        ...
        else
        {
            if(scrCostSheet.has(String(result.data[RESPONSE.FLATNUMBER]))) 
            {
                ...
                {
                    if(result.data.saleParticulars.otherParticulars[0][RESPONSE.COSTS][c][RESPONSE.COSTS] == 'Basic Price'  )
                    {
                    ...
                    else if(result.data.saleParticulars.otherParticulars[0][RESPONSE.COSTS][c][RESPONSE.COSTS] == 'Floor Rise' || result.data.saleParticulars.otherParticulars[0][RESPONSE.COSTS][c][RESPONSE.COSTS] == 'Floor Rise Charges' || result.data.saleParticulars.otherParticulars[0][RESPONSE.COSTS][c][RESPONSE.COSTS] == 'Floor Rise Charges (7th Floor onwards)' )
                    {
                    ...
                    else if(result.data.saleParticulars.otherParticulars[0][RESPONSE.COSTS][c][RESPONSE.COSTS] == 'Corner Premium'  || result.data.saleParticulars.otherParticulars[0][RESPONSE.COSTS][c][RESPONSE.COSTS] == 'Corner Flat Premium' || result.data.saleParticulars.otherParticulars[0][RESPONSE.COSTS][c][RESPONSE.COSTS] == 'Corner Flat Premium Charges')
                    {
                    ...
                    else if(result.data.saleParticulars.otherParticulars[0][RESPONSE.COSTS][c][RESPONSE.COSTS] == 'Infrastructure Charges' )
                    {
                    ...
                    else if(result.data.saleParticulars.otherParticulars[0][RESPONSE.COSTS][c][RESPONSE.COSTS] == 'Facilities and Amenities' ||  result.data.saleParticulars.otherParticulars[0][RESPONSE.COSTS][c][RESPONSE.COSTS] == 'Club Facilities & Amenities Charges')
                    {
                    ...
                    else if(result.data.saleParticulars.otherParticulars[0][RESPONSE.COSTS][c][RESPONSE.COSTS] == 'Car Parking (back to back)' || result.data.saleParticulars.otherParticulars[0][RESPONSE.COSTS][c][RESPONSE.COSTS] == 'Car Parking (Independent)' || result.data.saleParticulars.otherParticulars[0][RESPONSE.COSTS][c][RESPONSE.COSTS]== '1 Car and 1 Bike Parking Charges')
                    {
                    ...
                    else if(result.data.saleParticulars.otherParticulars[0][RESPONSE.COSTS][c][RESPONSE.COSTS] == 'Documentation' || result.data.saleParticulars.otherParticulars[0][RESPONSE.COSTS][c][RESPONSE.COSTS] == 'Documentation Charges' )
                    {
    ...
    const filePath1 = path.join(__dirname, EXCELS.SPECTRA_COSTSHEET_EXCEL);
